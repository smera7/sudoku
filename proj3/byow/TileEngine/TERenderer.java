...
public class TERenderer {
    ...
    public void initialize(int w, int h, int xOff, int yOff) {
        ...
        StdDraw.text((double) width / 2, height - 5, "CS61B: The Game");
        StdDraw.setFont(new Font("Monaco", Font.BOLD, TILE_SIZE - 2));
        StdDraw.text((double) width / 2, height - 10, "New Game (N)");
        StdDraw.text((double) width / 2, height - 13, "Load Game (L)");
        StdDraw.text((double) width / 2, height - 16, "Quit (Q)");
